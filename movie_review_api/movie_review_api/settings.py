...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'your-deployed-domain.com']  # Add your domain here for production
...
# JWT Authentication (if you want to use JWT instead of Token Authentication)
